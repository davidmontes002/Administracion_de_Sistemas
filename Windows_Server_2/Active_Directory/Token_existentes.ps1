...
$LlaveCuates = "JBSWY3DPEHPK3PXE"
$LlaveNoCuates = "JBSWY3DPEHPK3PXF"
...
$UsersNoCuates = Get-ADUser -Filter * -SearchBase "OU=no_cuates,$Dominio" -ErrorAction SilentlyContinue
